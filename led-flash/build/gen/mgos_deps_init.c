...
static const struct lib_descr {
  ...
  bool (*init)(void);
    ...
    // "fstab". deps: [ "core" "i2c" "spi" "vfs-common" "vfs-dev-part" "vfs-dev-spi-flash" "vfs-fs-spiffs" ]
    ...
    // "demo-bundle". deps: [ "adc" "atca" "aws" "azure" "ca-bundle" "core" "dash" "dht" "dns-sd" "fstab" "gcp" "http-server" "i2c" "neopixel" "ota-http-client" "ota-http-server" "ota-shadow" "provision" "pwm" "rpc-azure" "rpc-gcp" "rpc-loopback" "rpc-mqtt" "rpc-service-atca" "rpc-service-config" "rpc-service-fs" "rpc-service-gpio" "rpc-service-i2c" "rpc-service-ota" "rpc-service-wifi" "rpc-uart" "rpc-ws" "shadow" "sntp" "spi" "vfs-dev-spi-flash" "watson" "wifi" ]
